...
{
    /// <inheritdoc />
    public partial class addtbldanhmuctt2 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "P_DanhMucThuocTinh",
                columns: table => new
                {
                    Id = table.Column<int>(type: "NUMBER(10)", nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    MA = table.Column<string>(type: "VARCHAR2(100)", maxLength: 100, nullable: true),
                    TEN = table.Column<string>(type: "VARCHAR2(250)", maxLength: 250, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_P_DanhMucThuocTinh", x => x.Id);
                },
