    ...
    <div class="bg-gray-100 h-screen justify-center">
        <center class="mt-24 m-auto">
            ...
            <div class="tracking-widest mt-4">
                ...
                <span class="text-gray-500 text-xl">Xin lỗi, Trang bạn tìm kiếm không tồn tại!</span>
            </div>
        </center>
        <center class="mt-6">
            <a href="#" class="text-gray-500 font-mono text-xl bg-gray-200 p-3 rounded-md hover:shadow-md" @click="router.back()">Quay lại</a>
        </center>
    </div>
</template>
<script setup>
